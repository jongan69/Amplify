...
import createMaterialBottomTabNavigator from '../../Components/createMaterialBottomTabNavigator'
      ...
      <View style={detailView}>
        <Card>
          <CardSection>
            ...
            <Text>
              We provide access to hardware, workshops, and mentors that allow hackers to create
              without being limited by technology, information, or experience.
            </Text>
          </CardSection>
        </Card>
